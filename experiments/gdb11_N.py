...
plt.legend()
plt.ylabel("GDB-11 (22 Million)")
#ax.set_title("GDB-11 (22 Million)")
plt.xlabel("N: input size")
plt.tight_layout()
plt.savefig("gdb11_nao_nrs.jpg")
