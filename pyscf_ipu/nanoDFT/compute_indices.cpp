...
void _compute_symmetry(uint32_t& ij, 
                      uint32_t& kl, 
                      uint32_t& N,
                      uint32_t& symmetry, 
                      uint32_t& out) {
...
public:
  Input<Vector<uint32_t>> i_; 
  Input<Vector<uint32_t>> j_; 
  Input<Vector<uint32_t>> k_; 
  Input<Vector<uint32_t>> l_; 
  Input<Vector<uint32_t>> symmetry;
  Input<Vector<uint32_t>> input_N;
  ...
  bool compute() {
    ...
    for (uint32_t iteration = start[0]; iteration < stop[0]; iteration++){
      ...
      uint32_t i = i_[iteration]; 
      uint32_t j = j_[iteration];
      uint32_t k = k_[iteration];
      uint32_t l = l_[iteration];
