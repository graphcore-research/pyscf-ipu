...
POPLAR_ENGINE_OPTIONS="{\"autoReport.all\": \"true\", \"autoReport.directory\": \"/a/scratch/alexm/research/popvision/direct/\"}" TF_POPLAR_FLAGS=--show_progress_bar=true python direct.py $@
